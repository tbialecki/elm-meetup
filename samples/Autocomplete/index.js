...
var _tbialecki$elm_meetup$Model$Model = F3(
	function (a, b, c) {
		return {zipCode: a, places: b, status: c};
	});
var _tbialecki$elm_meetup$Model$Place = F4(
	function (a, b, c, d) {
		return {placeName: a, state: b, latitude: c, longitude: d};
	});
var _tbialecki$elm_meetup$Model$Error = {ctor: 'Error'};
...
var _tbialecki$elm_meetup$Msg$NoOp = {ctor: 'NoOp'};

var _tbialecki$elm_meetup$View$extractCityAndState = function (places) {
	var _p0 = _elm_lang$core$List$head(places);
	if (_p0.ctor === 'Just') {
		var _p1 = _p0._0;
		return {ctor: '_Tuple2', _0: _p1.placeName, _1: _p1.state};
	} else {
		return {ctor: '_Tuple2', _0: '', _1: ''};
	}
};
var _tbialecki$elm_meetup$View$resultView = function (model) {
	var _p2 = _tbialecki$elm_meetup$View$extractCityAndState(model.places);
	var city = _p2._0;
	var state = _p2._1;
	var _p3 = function () {
		...
		switch (_p4.ctor) {
			case 'Initial':
				return {ctor: '_Tuple2', _0: true, _1: 'control-group'};
			case 'Success':
				return {ctor: '_Tuple2', _0: false, _1: 'control-group success'};
			default:
				return {ctor: '_Tuple2', _0: true, _1: 'control-group error'};
		}
	}();
	var hideResult = _p3._0;
	var statusClass = _p3._1;
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Polish Address Completion')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class(statusClass)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Attributes$name('zip'),
										_elm_lang$html$Html_Attributes$placeholder('Type your ZIP here '),
										_elm_lang$html$Html_Events$onInput(_tbialecki$elm_meetup$Msg$SearchZipCode)
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]))
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$hidden(hideResult)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$type$('text'),
										_elm_lang$html$Html_Attributes$name('city'),
										_elm_lang$html$Html_Attributes$value(city)
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							])),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$type$('text'),
										_elm_lang$html$Html_Attributes$name('state'),
										_elm_lang$html$Html_Attributes$value(state)
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]))
...
var _tbialecki$elm_meetup$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('span8')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('hero-unit')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Zippoptamus')
									])),
								A2(
								_elm_lang$html$Html$br,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Try entering a zip code like 00-200 Warszawa')
									])),
								A2(
								_elm_lang$html$Html$br,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[])),
								_tbialecki$elm_meetup$View$resultView(model)
							]))
					]))
			]));
};

var _tbialecki$elm_meetup$Update$isZipCodeValid = function (zipCode) {
	var pattern = '[0-9]{2}-[0-9]{3}';
	var regex = _elm_lang$core$Regex$regex(pattern);
	return A2(_elm_lang$core$Regex$contains, regex, zipCode);
};
var _tbialecki$elm_meetup$Update$decodePlaces = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['places']),
	_elm_lang$core$Json_Decode$list(
		A5(
			...
			_tbialecki$elm_meetup$Model$Place,
			...
			A2(_elm_lang$core$Json_Decode_ops[':='], 'latitude', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'longitude', _elm_lang$core$Json_Decode$string))));
var _tbialecki$elm_meetup$Update$getPlaces = function (zip) {
	return A2(
		_evancz$elm_http$Http$get,
		_tbialecki$elm_meetup$Update$decodePlaces,
		A2(_elm_lang$core$Basics_ops['++'], 'http://api.zippopotam.us/pl/', zip));
};
var _tbialecki$elm_meetup$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
			...
			case 'SearchSucceeded':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{places: _p0._0, status: _tbialecki$elm_meetup$Model$Success}),
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{status: _tbialecki$elm_meetup$Model$Error}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _tbialecki$elm_meetup$Main$main === 'undefined' ? null : _tbialecki$elm_meetup$Main$main);
